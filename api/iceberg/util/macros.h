...
// [[deprecated]] is available since C++14
// This macro takes an optional deprecation message
#define ICEBERG_DEPRECATED(...) [[deprecated(__VA_ARGS__)]]
#define ICEBERG_DEPRECATED_ENUM_VALUE(...) [[deprecated(__VA_ARGS__)]]

// Macros to disable deprecation warnings

#ifdef __clang__
#  define ICEBERG_SUPPRESS_DEPRECATION_WARNING \
    _Pragma("clang diagnostic push");          \
    _Pragma("clang diagnostic ignored \"-Wdeprecated-declarations\"")
#  define ICEBERG_UNSUPPRESS_DEPRECATION_WARNING _Pragma("clang diagnostic pop")
#elif defined(__GNUC__)
#  define ICEBERG_SUPPRESS_DEPRECATION_WARNING \
    _Pragma("GCC diagnostic push");            \
    _Pragma("GCC diagnostic ignored \"-Wdeprecated-declarations\"")
#  define ICEBERG_UNSUPPRESS_DEPRECATION_WARNING _Pragma("GCC diagnostic pop")
#elif defined(_MSC_VER)
#  define ICEBERG_SUPPRESS_DEPRECATION_WARNING \
    __pragma(warning(push)) __pragma(warning(disable : 4996))
#  define ICEBERG_UNSUPPRESS_DEPRECATION_WARNING __pragma(warning(pop))
#else
#  define ICEBERG_SUPPRESS_DEPRECATION_WARNING
#  define ICEBERG_UNSUPPRESS_DEPRECATION_WARNING
#endif
...
#  define ICEBERG_DISABLE_UBSAN(feature) __attribute__((no_sanitize(feature)))
#else
