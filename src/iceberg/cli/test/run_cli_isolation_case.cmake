...
if(NOT DEFINED ISOLATION_FILE)
  message(FATAL_ERROR "ISOLATION_FILE is required")
endif()
...
execute_process(COMMAND "${CLI_EXECUTABLE}" --warehouse "${WAREHOUSE_DIR}" --isolation
                        "${ISOLATION_FILE}"
...
if(NOT cli_result EQUAL 0)
  message(FATAL_ERROR "CLI isolation test '${CASE_NAME}' failed with exit code ${cli_result}\n${actual_error}"
  )
endif()
...
if(NOT actual_output STREQUAL expected_output)
  message(FATAL_ERROR "CLI isolation test '${CASE_NAME}' output did not match expected output.\n"
                      "Spec: ${ISOLATION_FILE}\n"
